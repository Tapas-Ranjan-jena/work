...
export default function LLPMCACredentials() {
  ...
  return (
    <div className="llp-mca-credentials p-4">
      {/* ⭐ BREADCRUMBS */}
      <nav aria-label="breadcrumb" className="mb-4">
        <ol className="breadcrumb mb-0 small">
          ...
          {view === "list" ? (
             <li className="breadcrumb-item active" aria-current="page">LLP MCA Credentials List</li>
          ) : (
             <>
               <li className="breadcrumb-item"><a href="#" className="text-decoration-none text-primary" onClick={() => setView("list")}>LLP MCA Credentials</a></li>
               <li className="breadcrumb-item active" aria-current="page">Add LLP MCA Credential</li>
             </>
          )}
        </ol>
      </nav>
      ...
      {view === "list" && (
        <div className="card shadow-sm border-0 p-4">
           <div className="d-flex justify-content-between align-items-center mb-4">
              <h5 className="fw-bold mb-0">Particulars of LLP MCA Credentials</h5>
             ...
             <table className="table table-hover mb-0" style={{ fontSize: "11px" }}>
               <thead style={{ background: "#94a3b8", color: "white" }}>
                 <tr className="align-middle">
                   ...
                   <th className="px-2 py-2 border-end">Name of LLP</th>
                   <th className="px-2 py-2 border-end">LLPIN</th>
                   <th className="px-2 py-2 border-end">User ID/Password</th>
                   <th className="px-2 py-2 border-end">PAN</th>
                   <th className="px-2 py-2 border-end">Phone/Email</th>
                   <th className="px-2 py-2 border-end">Partner Name for OTP</th>
                   <th className="px-2 py-2 border-end">Partner Phone/Email</th>
      ...
      {view === "add" && (
        <div className="card shadow-sm border-0 p-4 position-relative">
           ...
           <div className="d-flex justify-content-between align-items-center mb-5 border-bottom pb-3">
              <h5 className="fw-bold mb-0">Enter Particulars of your LLP MCA account here.</h5>
           ...
           <div className="row g-0 text-start">
              ...
              <div className="col-md-6 mb-4 px-3">
                 <div className="row align-items-center">
                    <label className="col-md-4 fw-bold small">LLPIN</label>
                    <div className="col-md-8">
                       <input type="text" className="form-control border-light shadow-sm" placeholder="LLPIN" />
                    </div>
                 </div>
              </div>
              <div className="col-md-6 mb-4 px-3">
                 <div className="row align-items-center">
                    ...
                    <label className="col-md-4 fw-bold small">Name of LLP</label>
                    <div className="col-md-8">
                       <input type="text" className="form-control border-light shadow-sm" placeholder="Name of LLP" />
                    </div>
                 </div>
              </div>
              ...
              <div className="col-md-6 mb-4 px-3">
                 <div className="row align-items-center">
                    <label className="col-md-4 fw-bold small">Partner Name for OTP</label>
                    <div className="col-md-8">
                       <input type="text" className="form-control border-light shadow-sm" placeholder="Partner Name for OTP" />
                    </div>
                 </div>
              </div>
              ...
              <div className="col-md-6 mb-4 px-3">
                 <div className="row align-items-center">
                    <label className="col-md-4 fw-bold small">Partner Mail ID</label>
                    <div className="col-md-8">
                       <input type="email" className="form-control border-light shadow-sm" placeholder="Partner Mail ID" />
                    </div>
                 </div>
              </div>
              <div className="col-md-6 mb-4 px-3">
                 <div className="row align-items-center">
                    <label className="col-md-4 fw-bold small">Partner Ph No.</label>
                    <div className="col-md-8">
                       <input type="text" className="form-control border-light shadow-sm" placeholder="Partner Ph No." />
                    </div>
                 </div>
              </div>
                 ...
                 <div className="modal-body p-5">
                    <div className="row align-items-center bg-light p-4 rounded border">
                       ...
                       <div className="col-md-6">
                          ...
                          <div className="mt-2 text-start"><a href="#" className="small text-primary text-decoration-none">Download template file</a></div>
                       </div>
