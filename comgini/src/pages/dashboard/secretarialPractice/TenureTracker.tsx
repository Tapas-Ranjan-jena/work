...
type DirectorType = "Managing Director" | "Wholetime Director" | "Independent Director" | "Additional Director";

export default function TenureTracker() {
  const [activeTab, setActiveTab] = useState<DirectorType>("Managing Director");

  const tabs: DirectorType[] = ["Managing Director", "Wholetime Director", "Independent Director", "Additional Director"];

  return (
    <div className="tenure-tracker p-4">
      ...
      <div className="d-flex border-bottom mb-4" style={{ gap: "2px" }}>
        {tabs.map(tab => (
          <button 
            ...
            style={{ fontSize: "14px", borderBottom: activeTab === tab ? "2px solid #3b82f6" : "1px solid #dee2e6" }}
      ...
      <div className="card shadow-sm border-0 p-4">
        ...
        <div className="d-flex justify-content-between align-items-center mb-3 gap-3">
          ...
          <div className="d-flex align-items-center gap-2">
            ...
            <input type="text" className="form-control form-control-sm bg-white" style={{ maxWidth: "200px" }} />
          </div>
        </div>
        ...
        <div className="table-responsive border rounded overflow-auto mb-3" style={{ minHeight: "200px" }}>
          <table className="table table-hover mb-0" style={{ fontSize: "13px" }}>
            ...
            <tbody>
              <tr>
                <td colSpan={9} className="text-center py-4 text-dark opacity-75 fw-medium">No data available in table</td>
              </tr>
            </tbody>
          </table>
        </div>

        <div className="d-flex justify-content-between align-items-center bg-white px-2 mt-3">
