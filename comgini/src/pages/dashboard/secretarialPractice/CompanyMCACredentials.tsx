...
export default function CompanyMCACredentials() {
  ...
  return (
    <div className="company-mca-credentials p-4">
      {/* ⭐ BREADCRUMBS */}
      ...
      {view === "list" && (
        <div className="card shadow-sm border-0 p-4">
           <div className="d-flex justify-content-between align-items-center mb-4">
              <h5 className="fw-bold mb-0">Particulars of Company MCA Credentials</h5>
             ...
             <table className="table table-hover mb-0" style={{ fontSize: "11px" }}>
               <thead style={{ background: "#94a3b8", color: "white" }}>
                 <tr className="align-middle">
                   ...
                   <th className="px-2 py-2 border-end">CIN</th>
                   ...
                   <th className="px-2 py-2 border-end">Director Name for OTP</th>
                   <th className="px-2 py-2 border-end">Director Phone/Email</th>
      ...
      {view === "add" && (
        <div className="card shadow-sm border-0 p-4 position-relative">
           ...
           <div className="d-flex justify-content-between align-items-center mb-5 border-bottom pb-3">
              <h5 className="fw-bold mb-0">Enter Particulars of your Company MCA account here.</h5>
           ...
           <div className="row g-0 text-start">
              ...
              <div className="col-md-6 mb-4 px-3">
                 <div className="row align-items-center">
                    <label className="col-md-4 fw-bold small">CIN</label>
                    <div className="col-md-8">
                       <input type="text" className="form-control border-light shadow-sm" placeholder="CIN" />
                    </div>
                 </div>
              </div>
              <div className="col-md-6 mb-4 px-3">
                 <div className="row align-items-center">
                    ...
                    <label className="col-md-4 fw-bold small">Name of Company</label>
                    <div className="col-md-8">
                       <input type="text" className="form-control border-light shadow-sm" placeholder="Name of Company" />
                    </div>
                 </div>
              </div>
              ...
              <div className="col-md-6 mb-4 px-3">
                 <div className="row align-items-center">
                    <label className="col-md-4 fw-bold small">Director Name for OTP</label>
                    <div className="col-md-8">
                       <input type="text" className="form-control border-light shadow-sm" placeholder="Director Name for OTP" />
                    </div>
                 </div>
              </div>
              ...
              <div className="col-md-6 mb-4 px-3">
                 <div className="row align-items-center">
                    <label className="col-md-4 fw-bold small">Director Mail ID</label>
                    <div className="col-md-8">
                       <input type="email" className="form-control border-light shadow-sm" placeholder="Director Mail ID" />
                    </div>
                 </div>
              </div>
              <div className="col-md-6 mb-4 px-3">
                 <div className="row align-items-center">
                    <label className="col-md-4 fw-bold small">Director Ph No.</label>
                    <div className="col-md-8">
                       <input type="text" className="form-control border-light shadow-sm" placeholder="Director Ph No." />
                    </div>
                 </div>
              </div>
              ...
              <div className="modal-content overflow-hidden border-0 shadow">
                 ...
                 <div className="modal-body p-5">
                    <div className="row align-items-center bg-light p-4 rounded border">
                       <div className="col-md-3 fw-bold small text-start">Choose file</div>
