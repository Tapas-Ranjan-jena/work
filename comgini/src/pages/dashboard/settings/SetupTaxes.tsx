...
export default function SetupTaxes() {
  const [taxes] = useState([
    ...
    { id: 4, name: "TDS 10%", rate: "10%", type: "Percentage" },
  ]);

  return (
    <div className="setup-taxes text-start">
          ...
          <table className="table table-hover align-middle mb-0" style={{ fontSize: "14px" }}>
            <thead className="table-light">
              <tr className="text-nowrap">
                <th className="fw-semibold px-3 py-3" style={{ minWidth: "200px" }}>Tax Name</th>
                <th className="fw-semibold px-3 text-center" style={{ minWidth: "100px" }}>Rate</th>
                <th className="fw-semibold px-3 text-center" style={{ minWidth: "150px" }}>Type</th>
                <th className="fw-semibold text-center px-3" style={{ width: "120px", minWidth: "120px" }}><i className="bi bi-list"></i></th>
              </tr>
            </thead>
            <tbody>
              {taxes.map((tax) => (
                <tr key={tax.id} className="text-nowrap">
                  <td className="px-3 py-3 text-dark fw-medium">{tax.name}</td>
                  <td className="px-3 text-center text-muted fw-semibold">{tax.rate}</td>
                  <td className="px-3 text-center text-muted">{tax.type}</td>
