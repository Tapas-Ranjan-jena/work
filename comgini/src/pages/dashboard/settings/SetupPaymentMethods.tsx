...
export default function SetupPaymentMethods() {
  const [methods] = useState([
    { id: 1, title: "Cash", status: "Active" },
    { id: 2, title: "Bank Transfer", status: "Active" },
    { id: 3, title: "Cheque", status: "Active" },
    { id: 4, title: "UPI", status: "Active" },
  ]);

  return (
    <div className="setup-payment-methods text-start">
      <div className="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center mb-4 gap-3">
        <h5 className="fw-bold mb-0">Payment Methods</h5>
        <button className="btn btn-outline-dark btn-sm d-flex align-items-center gap-2 px-3 py-2 shadow-sm bg-white w-100 w-sm-auto" style={{ borderRadius: "8px", fontSize: "13.5px" }}>
      ...
      <div className="card shadow-sm border-0 mb-4">
        <div className="card-header bg-white border-bottom p-2 d-flex flex-column flex-md-row justify-content-between align-items-stretch align-items-md-center gap-3">
          ...
          <div className="d-flex flex-column flex-sm-row align-items-stretch align-items-sm-center gap-2">
            ...
            <button className="btn btn-light border btn-sm px-4 py-2 bg-white flex-fill w-sm-auto shadow-none" style={{ borderRadius: "8px", fontSize: "13.5px" }}>Print</button>
          </div>
        </div>
          ...
          <table className="table table-hover align-middle mb-0" style={{ fontSize: "14px" }}>
            <thead className="table-light">
              <tr className="text-nowrap">
                <th className="fw-semibold px-3 py-3" style={{ minWidth: "300px" }}>Method Title</th>
                <th className="fw-semibold text-center px-3" style={{ width: "120px", minWidth: "120px" }}><i className="bi bi-list"></i></th>
              </tr>
            </thead>
            <tbody>
              {methods.map((method) => (
                <tr key={method.id} className="text-nowrap">
                  <td className="px-3 py-3 text-dark fw-medium">{method.title}</td>
