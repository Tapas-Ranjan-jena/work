...
export default function OfficialHolidayModal({ onClose }: Props) {
    return (
        <div className="modal-overlay">
            <div className="modal-box" style={{ maxWidth: "800px", padding: 0, overflow: "hidden" }}>
                ...
                <div className="d-flex justify-content-between align-items-center p-3 px-4 border-bottom bg-white">
                    <h5 className="fw-bold mb-0">Official Holiday</h5>
                ...
                <form className="p-4 bg-white">
                    <div className="row g-4">
                        ...
                        <div className="col-12 d-flex align-items-center gap-3">
                            <label className="text-muted w-150-px">Event</label>
                        ...
                        <div className="col-12 d-flex align-items-center gap-3">
                            ...
                            <div className="form-control d-flex gap-4 p-2 px-3 border-light shadow-none" style={{ background: '#fff' }}>
                                <label className="d-flex align-items-center gap-2 small cursor-pointer">
                                    <input type="radio" name="duration" defaultChecked style={{ width: '16px', height: '16px', accentColor: '#3498db' }} /> Full Day
                                </label>
                                <label className="d-flex align-items-center gap-2 small cursor-pointer">
                                    <input type="radio" name="duration" style={{ width: '16px', height: '16px', accentColor: '#3498db' }} /> Half Day
                                </label>
                            </div>
                        </div>
